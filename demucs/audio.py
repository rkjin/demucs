    ...
    def read(self,
        ...
        with temp_filenames(len(streams)) as filenames: #'/tmp/tmpmt997s2i'
            ...
            for stream, filename in zip(streams, filenames):
                ...
                command += [filename]
                # seek_time 32
                # ['ffmpeg', '-y', '-loglevel', 'panic', '-ss', '32', '-i', '/content/demucs/data/musdb18/train/Aimee Norwich - Child.stem.mp4', '-map', '0:1', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmpl2lhv9ll', '-map', '0:2', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmpucbbdtx0', '-map', '0:3', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmpqknnyl_e', '-map', '0:4', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmpozbh55d1']
                # seek_time 55
                # ['ffmpeg', '-y', '-loglevel', 'panic', '-ss', '55', '-i', "/content/demucs/data/musdb18/train/Actions - Devil's Words.stem.mp4", '-map', '0:1', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmph7n3qxdl', '-map', '0:2', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmp2smylbmc', '-map', '0:3', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmpwtpppf0f', '-map', '0:4', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmpb3hmy6ul']
                # seek_time 48
                # ['ffmpeg', '-y', '-loglevel', 'panic', '-ss', '48', '-i', '/content/demucs/data/musdb18/train/A Classic Education - NightOwl.stem.mp4', '-map', '0:1', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmpp_4bz487', '-map', '0:2', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmpnbyhcwk0', '-map', '0:3', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmp4vjihsi7', '-map', '0:4', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmpm66665zn']
                # seek_time 105
                # ['ffmpeg', '-y', '-loglevel', 'panic', '-ss', '105', '-i', '/content/demucs/data/musdb18/train/A Classic Education - NightOwl.stem.mp4', '-map', '0:1', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmp78x_xuny', '-map', '0:2', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmpfuui39yr', '-map', '0:3', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmpy3_3j51k', '-map', '0:4', '-t', '11.13938775510204', '-threads', '1', '-f', 'f32le', '-ar', '44100', '/tmp/tmpzugib69v']
                # seek_time 152
